...
public class SwiftFlutterZoomSdkPlugin: NSObject, FlutterPlugin,FlutterStreamHandler , MobileRTCMeetingServiceDelegate {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    let channel = FlutterMethodChannel(name: "com.wv/flutter_zoom", binaryMessenger: messenger) //com.evilratt/zoom_sdk
...
public class SwiftFlutterZoomSdkPlugin: NSObject, FlutterPlugin,FlutterStreamHandler , MobileRTCMeetingServiceDelegate {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    let eventChannel = FlutterEventChannel(name: "com.wv/flutter_zoom_event_stream", binaryMessenger: messenger) //com.evilratt/zoom_sdk_event_stream
