...
export 'package:flutter_zoom/zoom_platform_view.dart' show ZoomOptions, ZoomMeetingOptions;
...
class ZoomViewWeb extends ZoomPlatform {
  ...
  String generateSignature(String apiKey, String apiSecret, String meetingNumber, int role) {
